...
exports.VSCodeCommandError = exports.Version = exports.isPlatformCLI = exports.isPlatformServer = exports.isPlatformDarwin = exports.isPlatformWindows = exports.systemDefaultPlatform = void 0;
...
function downloadDirToExecutablePath(dir, platform) {
    if ((0, exports.isPlatformWindows)(platform)) {
        return (0, exports.isPlatformServer)(platform) ? path.resolve(dir, 'bin', 'code-server.cmd') : path.resolve(dir, 'Code.exe');
    }
    else if ((0, exports.isPlatformServer)(platform)) {
...
function insidersDownloadDirToExecutablePath(dir, platform) {
    if ((0, exports.isPlatformWindows)(platform)) {
        return (0, exports.isPlatformServer)(platform)
